...
export default {
    components : { 
        ProductMagazine: defineAsyncComponent(() => import( /* webpackChunkName: "ProductMagazine" */ '../components/ProductMagazine'))
        },
    data() {
        return {
            api: "https://bookstore-macad-backend.herokuapp.com/magazine/",
            productData:[],
        }
    },
    methods:{
